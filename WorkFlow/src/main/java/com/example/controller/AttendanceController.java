...
public class AttendanceController {
	 ...
	 */
	@PostMapping("/punch")
	public String punch(@RequestParam("type") String type, @AuthenticationPrincipal UserDetails userDetails) {
	...
	public String getHistory(@AuthenticationPrincipal UserDetails userDetails,
	...
	public void exportCsv(@AuthenticationPrincipal UserDetails userDetails,
		...
		for (AttendanceSummaryDto dto : summaries) {
			writer.printf("%s,%s,%s,%s,%s%n", dto.getWorkDate(), dto.getWorkStart(), dto.getWorkEnd(),
					dto.getWorkingMinutes(), dto.getBreakMinutes());
		}
		writer.flush();
	}
}